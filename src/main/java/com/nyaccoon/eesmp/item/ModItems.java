...
public class ModItems{
    ...
    public static final Item SHARD_OF_DEATH = registerItem("shard_of_death", new ShardOfDeath(new Item.Settings().rarity(Rarity.EPIC).maxCount(1)));
    public static final Item SHARD_OF_DREAMS = registerItem("shard_of_dreams", new ShardOfDreams(new Item.Settings().rarity(Rarity.EPIC).maxCount(1)));
    public static final Item SHARD_OF_REALITY = registerItem("shard_of_reality", new ShardOfReality(new Item.Settings().rarity(Rarity.EPIC).maxCount(1)));
    ...
    //hearts
    public static final Item HEART_OF_IRELLIA = registerItem("heart_of_irellia", new HeartOfIrellia(new Item.Settings().rarity(Rarity.EPIC).maxCount(1)));
    ...
    public static final Item HEART_OF_REALITY = registerItem("heart_of_reality", new HeartOfReality(new Item.Settings().rarity(Rarity.EPIC).maxCount(1)));
